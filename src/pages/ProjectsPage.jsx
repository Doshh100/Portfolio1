      ...
      <div className="content" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div className="projects-grid">
          ...
          <div className="project-card">
            ...
            <div className="project-links">
              <a href="https://github.com/Doshh100/-Doshh100-.github.io/tree/main/BankingSystem" target="_blank" rel="noopener noreferrer">GitHub</a>
            </div>
          ...
          <div className="project-card">
            ...
            <div className="project-links">
              <a href="https://github.com/Doshh100/space-portfolio" target="_blank" rel="noopener noreferrer">GitHub</a>
            </div>
